...
namespace ViewWindow.Model
{
    ...
    public class HWndCtrl
    {
        ...
        public void clearHObjectList()
        {
            ...
            {
                if (hObjectWithColor.HObject != null)
                {
        ...
        private void showHObjectList()
        {
            try
            {
                foreach (HObjectWithColor hObjectWithColor in hObjectList)
                {
                    if (hObjectWithColor.Color != null)//设置颜色
                    {
                    ...
                    if (hObjectWithColor.Draw != null)//设置显示方式
                    {
                    ...
                    if (hObjectWithColor.HobjectString != null)//如果是显示字符型的
                    {
                        HOperatorSet.SetTposition(viewPort.HalconWindow, hObjectWithColor.HobjectString.Y, hObjectWithColor.HobjectString.X);
                        HOperatorSet.WriteString(viewPort.HalconWindow, hObjectWithColor.HobjectString.str);
                    }
                    else
                    {
