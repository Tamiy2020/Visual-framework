...
namespace ChoiceTech.Halcon.Control
{
    ...
    /// </summary>
    public partial class DpWin : UserControl
    {
        #region 私有变量定义.
        ...
        /// <summary>
        /// 打印字符的间距，非原有属性，我自己定义的属性///////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// </summary>
        public int StringHeight { get { return hWindowControl.ImagePart.Height / 65 + 1; } set { } }
        /// <summary>
        /// 设置image,初始化控件参数
        /// </summary>
        public HImage Image
        ...
        public void DispObj(HObject hObj, string color, string draw)
        {
            lock (this)
            {
